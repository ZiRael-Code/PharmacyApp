...
class SendInvites extends StatefulWidget {
  SendInvites({super.key, required List<String> selectedContacts});
  @override
...
class _SendInvitesScreen extends State<SendInvites> {
              ...
              child: Column(
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        contact(alphaOrder: 'A', name: "Alexander Trelawney"),
                        contact(alphaOrder: 'A', name: "Alexander Trelawney"),
                        contact(alphaOrder: 'B', name: "Benjamin Osagie"),
                        contact(alphaOrder: 'A', name: "Alexander Trelawney"),
                      ],
                    ),
                  ),
  ...
  contact({required String alphaOrder, required String name}) {
    return Container(
              ...
              child: Stack(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: Color(0xff2e2e42), shape: BoxShape.circle),
                    child: Text(
                      alphaOrder,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: getFontSize(35, context),
                          fontWeight: FontWeight.bold),
                    ),
                  ),
                  Align(
  ...
  referOption({icon, required String referText}) {
    return Column(
      children: [
        Container(
