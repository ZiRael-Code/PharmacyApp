import 'package:pharmacy_app/Patient/PrescribeDrugsAddDrug.dart';
...
class _OrderPrescriptionState extends State<OrderPrescription> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> filteredNames = names
        .where(
            (name) => name['name'].toLowerCase().contains(query.toLowerCase()))
        .toList();
    return Scaffold(
      appBar: AppBar(
        title: Row(
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (builder) =>
                                  PrescribeDrugsAddDrugs()), // Navigate to Login screen
                        );
                ...
                ? Column(children: [
                    ...
                    SizedBox(
                      ...
                      child: Text(
                          ...
                          "Click on the search bar and type in the patients you want to send prescriptions to."),
                    ),
                  ])
                : Container(),
